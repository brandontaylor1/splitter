...
calculateBtn.addEventListener("click", () => {    
    ...
    let tipAmount = calculateTipAmountPerPerson(billAmount, tipPercentage, numberOfPeople)
    let totalAmount = calculateTotalAmountPerPerson(billAmount, tipAmount, numberOfPeople)
