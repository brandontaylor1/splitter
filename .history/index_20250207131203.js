...
calculateBtn.addEventListener("click", () => {    
    let hasError = false;
    const billAmount = document.querySelector("#bill-input").value;
    console.log(billAmount)
    const tipPercentage = document.querySelector(".active").value;
    console.log(tipPercentage)
    const numberOfPeople = document.querySelector("#number-of-people-input").value;
    console.log(numberOfPeople)

    if(billAmount === undefined || !tipPercentage === undefined || !numberOfPeople) {
        hasError = true;
